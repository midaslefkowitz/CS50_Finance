<?php
	...
	/**
     * Renders login template, passing in values.
     */
    function renderRegister($template, $values = [])
    {
        // if template exists, render it
        if (file_exists("../templates/$template"))
        {
            ...
            // render header
            require("../templates/register_header.php");
    ...
    function backendRegister($template, $values = [])
    {
        ...
        if (file_exists("../templates/$template"))
        {
            ...
            // render header
            require("../templates/backend_header.php");
